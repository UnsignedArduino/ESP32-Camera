...
// User_Setup_Select.h) #define DISABLE_ALL_LIBRARY_WARNINGS
...
// Reset pin (could connect to NodeMCU RST, see next line) #define TFT_RST  -1
...
// the PIO interface. #define RP2040_PIO_SPI // Leave commented out to use
// standard RP2040 SPI port interface

// For the RP2040 processor define the SPI port channel used (default 0 if
// undefined) #define TFT_SPI_PORT 1 // Set to 0 if SPI0 pins are used, or 1 if
// spi1 pins used

// For the STM32 processor define the SPI port channel used (default 1 if
// undefined) #define TFT_SPI_PORT 2 // Set to 1 for SPI port 1, or 2 for SPI
// port 2
